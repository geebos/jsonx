import { JsonDetector, JsonSubstring } from '../types/json';

/**
 * JSON 检测器实现
 */
export class JsonDetectorImpl implements JsonDetector {
  /**
...
// 导出单例实例
export const jsonDetector = new JsonDetectorImpl();
